//Voici l'implémentation de l'algorithme cryptograph RSA en C. Le programme attend un fichier d'entrée, plain.txt,
//qui doit contenir le texte brut et génère un fichier de sortie, decipher.txt, qui contient notre texte décrypté.
//Il génère également un fichier intermédiaire, cipher.txt, qui contient le texte chiffré en bits.
...
int main(void)
{
    ...
    // détruit le contenu de ces fichiers (des exécutions précédentes, le cas échéant)
